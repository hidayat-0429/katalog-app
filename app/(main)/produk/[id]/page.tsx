        ...
        <div className="flex flex-col">
          <div className="mb-6">
            ...
            <div className="flex items-center gap-2 font-sans text-xs text-neutral-500 dark:text-neutral-400 mb-4">
              ...
              <span>
                Status: <strong className="text-neutral-900 dark:text-neutral-100">{product.stock > 0 ? `Tersedia ${product.stock} ${product.unit}` : 'Habis'}</strong>
              </span>
            </div>
            ...
            <div className="space-y-3 pt-3 border-t border-neutral-200 dark:border-neutral-700">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-sans text-xs font-semibold text-brand-forest-700 dark:text-brand-forest-300">Dipanen segar, jamin 24 jam</span>
              </div>
          ...
          <div className="space-y-4">
            {!user ? (
              ...
              <div className="flex items-center gap-2.5 bg-neutral-50 dark:bg-neutral-800/50 text-neutral-500 dark:text-neutral-400 p-4 rounded-lg border border-neutral-200 dark:border-neutral-700 font-sans text-xs">
                ...
                <span>Akun Admin sedang aktif. Gunakan akun Pembeli untuk memesan.</span>
              </div>
            ) : product.stock === 0 ? (
      ...
      <div className="mt-12 pt-12 border-t border-neutral-200 dark:border-neutral-700">
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-neutral-50 dark:bg-neutral-800/50 rounded-lg p-6 border border-neutral-200 dark:border-neutral-700">
            <h3 className="font-heading font-bold text-sm text-neutral-900 dark:text-neutral-100 mb-3">Panduan Penyimpanan</h3>
            <ul className="space-y-2 text-xs text-neutral-600 dark:text-neutral-400 leading-relaxed">
              <li>• Suhu optimal: 2-4°C (lemari pendingin)</li>
              <li>• Tahan hingga 3-5 hari dalam plastik kedap</li>
              <li>• Hindari panas langsung dan kelembaban berlebih</li>
              <li>• Cuci sebelum digunakan</li>
            </ul>
          </div>

          {/* Kegunaan */}
          <div className="bg-neutral-50 dark:bg-neutral-800/50 rounded-lg p-6 border border-neutral-200 dark:border-neutral-700">
            <h3 className="font-heading font-bold text-sm text-neutral-900 dark:text-neutral-100 mb-3">Cocok untuk</h3>
            <ul className="space-y-2 text-xs text-neutral-600 dark:text-neutral-400 leading-relaxed">
              <li>• Masakan tumis dan sup</li>
              <li>• Pizza dan pasta topping</li>
              <li>• Hidangan oriental</li>
              <li>• Menu diet sehat rendah kalori</li>
            </ul>
          </div>

          {/* Keuntungan Bulk */}
          <div className="bg-neutral-50 dark:bg-neutral-800/50 rounded-lg p-6 border border-neutral-200 dark:border-neutral-700">
            <h3 className="font-heading font-bold text-sm text-neutral-900 dark:text-neutral-100 mb-3">Keuntungan Pembelian Bulk</h3>
            <ul className="space-y-2 text-xs text-neutral-600 dark:text-neutral-400 leading-relaxed">
              <li>✓ Harga per unit lebih murah</li>
              <li>✓ Tersedia pengiriman gratis</li>
              <li>✓ Dukungan dedicated account manager</li>
              <li>✓ Jaminan kualitas konsisten</li>
            </ul>
          </div>
        </div>
      </div>
